...
luamain = function(void)
	...
	--Enable and Disable in Homepage
	stReEn=hmt.readvp16(0x089004)
	if stReEn==1 then
		if CommTimeoutErrorCheck==4 then
			checkStopResEn==1
		else
		...
		hmt.writevp16(0x89002,0)
		hmt.writevp16(0x89000,0)
		hmt.writevp16(0x80970,0)
		hmt.writevp16(0x8097E,1)
		hmt.writevp16(0x89006,0)
		hmt.writevp16(0x8012A,0)
		hmt.writevp16(0x89022,1)
	else
		checkStopResEn=1
		hmt.writevp16(0x89002,1)
		hmt.writevp16(0x89000,1)
		hmt.writevp16(0x80970,1)
		hmt.writevp16(0x8097E,0)
		hmt.writevp16(0x89006,1)
		hmt.writevp16(0x8012A,1)
		hmt.writevp16(0x89022,0)
	end	
	

	--Checking Communication Failure
	if CommTimeoutErrorCheck==4 or stReEn==1 then
		PreBuzz 	= hmt.readvp16(0x081000)
		PreFillDefog= hmt.readvp16(0x08012A)
		if checkStopResEn==1 then
